...
init_parameters['hbottom'] = 1.2*(10**-9)
init_parameters['hbuffer'] = 0.6*(10**-9)
init_parameters['htop'] = 0.9*(10**-9)
init_parameters['hadd'] = 2.4*(10**-9)
init_parameters['Mmean'] = 287*(10**-18)
init_parameters['Rmean'] = 140*(10**-9)
init_parameters['Angle'] = 0
init_parameters['Hext'] = 0

##### ADD PARAMETERS
modeling_parameters = dict()
modeling_parameters['CountNP'] = 10
modeling_parameters['Incr'] = 1 # увеличиваем момент наночастиц в Incr раз
modeling_parameters['OUTPUTDIR'] = "modeling_progs/programms/MR/bilayer/CoFeB2Ta2CoFeB/300K/FieldPartPlusExternal/data/"
...
def TotalField(x, y, z, angle, Hext, coords_parts):
    ...
    znp_common = init_parameters['hbottom'] + init_parameters['hbuffer'] + init_parameters['htop'] + init_parameters['hadd'] + \
...
#! Пайплайн
def Pipeline():
    Ztotal = init_parameters['hbottom'] + init_parameters['hbuffer'] + init_parameters['htop']
...
def HardPipeline():
    ...
    for angle in [0, 30, 60, 90]:
        for Hext in [90, 150]:
            ...
            dirpath = modeling_parameters['OUTPUTDIR'] + str(angle) + "deg_ManyNPs/"
            filepath = dirpath + "field_" + str(Hext) + "_Oe.csv"
